...
public class Sme extends javax.swing.JFrame {
    
    private static Sme main;
    ...
    private void init() {
        ...
        menu_sme1.addEvent(new EventMenuSelected() {
            @Override
            public void menuSelected(int index, int indexSubMenu) {
                if (index == 0 && indexSubMenu == 0) {
                    showForm(new Form_sme());
                }
             //emp tab
        ...
        menu_sme1.setSelectedIndex(0, 0);
    }
    ...
    private void initComponents() {
        ...
        menu_sme1 = new jdev.menu.Menu_sme();
        ...
        panelMenuLayout.setHorizontalGroup(
            ...
            .addGroup(panelMenuLayout.createSequentialGroup()
                .addGroup(panelMenuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(menu_sme1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        panelMenuLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelMenuLayout.createSequentialGroup()
                ...
                .addComponent(menu_sme1, javax.swing.GroupLayout.DEFAULT_SIZE, 584, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private jdev.menu.Menu_sme menu_sme1;
